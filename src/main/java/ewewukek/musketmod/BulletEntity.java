...
public class BulletEntity extends AbstractHurtingProjectile {
    ...
    public static final ResourceKey<DamageType> MUSKET = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(MODID, "musket"));

    public DamageSource causeMusketDamage(BulletEntity bullet, Entity attacker) {
        return level().damageSources().source(MUSKET, bullet, attacker);
    }
